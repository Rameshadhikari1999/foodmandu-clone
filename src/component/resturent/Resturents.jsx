  ...
  return (
    <div className="w-full">
      <div className="w-full mt-[10%] lg:mt-[5%] ">
        ...
        >
          <div className="w-full h-full  bg-black bg-opacity-50  flex items-end gap-3 pl-5 pb-5">
            ...
            <div className="text-white text-xl font-roboto">
              ...
              <p className="flex items-center text-sm">
                <FaStar className="ml-2 text-white" /> Italian
              </p>
              <p className="flex items-center text-sm">
                <FaLocationDot className="ml-2 text-white" /> Sanepa
              </p>
            </div>
          </div>
        </div>
